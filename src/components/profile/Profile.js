  ...
  render() {
    return (
      <div className="flex flex-col overflow-hidden pb-10">
        ...
        <div className="flex-col justify-left -mt-16 mx-44">
          <div className="flex items-center">
            <img
              src={img1}
              alt="ProfileImage"
              className="rounded-full border-solid border-white w-52 h-52 border-8 -mt-5"
            />
            <div className="flex-col text-left items-center pl-10">
            ...
            <div className="grid md:grid-cols-2">
              <div className="grid gap-y-3">
                ...
                <div className="grid gap-y-2">
                  ...
                  <div className="flex gap-x-2 items-center font-Helvetica font-bold text-[12px]">
                    <span
              ...
              <div className="flex-col h-[310px] m-10 p-5 items-center justify-center border border-gray-300 rounded-3xl">
                ...
                <div className="grid grid-cols-5 gap-x-3 mt-5">
                  <div className="flex-col font-semibold font-Poppins text-center border border-[#D5D3D3] rounded">
                    <p className="md:text-[10px] text-[5px] text-[#B4B4B4]">
                      Thur
                    </p>
                    <p className="md:text-[14px] text-[#565656] text-[6px]">
                      28 April
                    </p>
                    <p className="text-[#5B6BD0] md:text-[10px] text-[5px]">
                      2 slots
                    </p>
                  </div>
                  <div className="flex-col font-semibold font-Poppins text-center border border-[#D5D3D3] rounded">
                ...
                <div className="flex-col py-5">
                  ...
                  <div className="grid grid-cols-5 gap-x-5 mt-2">
                    <div className="flex-col font-semibold font-Poppins text-center border border-[#D5D3D3] rounded">
                      <p className="md:text-[10px] p-1 text-[5px] text-[#565656]">
                        10 am
                      </p>
                    </div>
                    <div className="flex-col font-semibold font-Poppins text-center border border-[#D5D3D3] rounded">
